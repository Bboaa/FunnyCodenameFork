...
import funkin.backend.utils.VisShit.CurAudioInfo;
import funkin.backend.utils.MeshRender;
...
class PolygonSpectogram extends MeshRender
{
	...
	public var direction:VisDirection;

	public function new(?daSound:FlxSound, ?col:FlxColor = FlxColor.WHITE, ?height:Float = 720, ?detail:Float = 1, ?direction:VisDirection = HORIZONTAL)
	{
		super(0, 0, col);
